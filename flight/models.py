...
class User(AbstractUser):
    class Meta:
        verbose_name_plural = '6.Người dùng '
    def __str__(self):
...
class Week(models.Model):
    ...
    class Meta:
        verbose_name_plural = '2.Tuần'
    def __str__(self):
        return f"{self.name} ({self.number})"


class Flight(models.Model):
    origin = models.ForeignKey(Place, on_delete=models.CASCADE, related_name="departures", verbose_name="place of origin")
    destination = models.ForeignKey(Place, on_delete=models.CASCADE, related_name="arrivals", verbose_name="destination")
    ...
    class Meta:
        verbose_name_plural = '3.Chuyến bay'
    def __str__(self):
...
class Passenger(models.Model):
    ...
    class Meta:
        verbose_name_plural = '4.Hành khách'
    def __str__(self):
